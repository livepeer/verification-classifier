...
def verify(source_uri, renditions, do_profiling, max_samples, model_dir, debug=False, gpu=False):
    """
    ...
    # Prepare source and renditions for verification
        ...
        predictions_df['sl_pred_tamper_proba'] = loaded_model_sl.predict_proba(x_renditions_ul)[...,-1]
        ...
        for _, rendition in enumerate(renditions):
            if rendition['video_available']:
                ...
                rendition['tamper_sl_proba'] = predictions_df['sl_pred_tamper_proba'].iloc[i]
