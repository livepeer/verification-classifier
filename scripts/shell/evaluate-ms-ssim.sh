...
INPUT_FOLDER_144_WATERMARK="$1/240p_watermark"
...
for main_file in $INPUT_FOLDER_1080/* ; do
    ...
    bash -c "do_process \"$main_file\" \"$INPUT_FOLDER_1080_WATERMARK/$filenamewithextensiom\" \"$OUTPUT_FOLDER/ms-ssim/1080_watermark/$filenamewithoutextension/$filenamewithoutextension\"\"_1080.log\""
    bash -c "do_process \"$main_file\" \"$INPUT_FOLDER_720_WATERMARK/$filenamewithextensiom\" \"$OUTPUT_FOLDER/ms-ssim/720_watermark/$filenamewithoutextension/$filenamewithoutextension\"\"_720.log\""
    bash -c "do_process \"$main_file\" \"$INPUT_FOLDER_480_WATERMARK/$filenamewithextensiom\" \"$OUTPUT_FOLDER/ms-ssim/480_watermark/$filenamewithoutextension/$filenamewithoutextension\"\"_480.log\""
    bash -c "do_process \"$main_file\" \"$INPUT_FOLDER_360_WATERMARK/$filenamewithextensiom\" \"$OUTPUT_FOLDER/ms-ssim/360_watermark/$filenamewithoutextension/$filenamewithoutextension\"\"_360.log\""
    bash -c "do_process \"$main_file\" \"$INPUT_FOLDER_240_WATERMARK/$filenamewithextensiom\" \"$OUTPUT_FOLDER/ms-ssim/240_watermark/$filenamewithoutextension/$filenamewithoutextension\"\"_240.log\""
    bash -c "do_process \"$main_file\" \"$INPUT_FOLDER_144_WATERMARK/$filenamewithextensiom\" \"$OUTPUT_FOLDER/ms-ssim/144_watermark/$filenamewithoutextension/$filenamewithoutextension\"\"_144.log\""

    bash -c "do_process \"$main_file\" \"$INPUT_FOLDER_1080_FLIP_VERTICAL/$filenamewithextensiom\" \"$OUTPUT_FOLDER/ms-ssim/1080_flip_vertical/$filenamewithoutextension/$filenamewithoutextension\"\"_1080.log\""
    bash -c "do_process \"$main_file\" \"$INPUT_FOLDER_720_FLIP_VERTICAL/$filenamewithextensiom\" \"$OUTPUT_FOLDER/ms-ssim/720_flip_vertical/$filenamewithoutextension/$filenamewithoutextension\"\"_720.log\""
    bash -c "do_process \"$main_file\" \"$INPUT_FOLDER_480_FLIP_VERTICAL/$filenamewithextensiom\" \"$OUTPUT_FOLDER/ms-ssim/480_flip_vertical/$filenamewithoutextension/$filenamewithoutextension\"\"_480.log\""
    bash -c "do_process \"$main_file\" \"$INPUT_FOLDER_360_FLIP_VERTICAL/$filenamewithextensiom\" \"$OUTPUT_FOLDER/ms-ssim/360_flip_vertical/$filenamewithoutextension/$filenamewithoutextension\"\"_360.log\""
    bash -c "do_process \"$main_file\" \"$INPUT_FOLDER_240_FLIP_VERTICAL/$filenamewithextensiom\" \"$OUTPUT_FOLDER/ms-ssim/240_flip_vertical/$filenamewithoutextension/$filenamewithoutextension\"\"_240.log\""
    bash -c "do_process \"$main_file\" \"$INPUT_FOLDER_144_FLIP_VERTICAL/$filenamewithextensiom\" \"$OUTPUT_FOLDER/ms-ssim/144_flip_vertical/$filenamewithoutextension/$filenamewithoutextension\"\"_144.log\""

    bash -c "do_process \"$main_file\" \"$INPUT_FOLDER_1080_FLIP_HORIZONTAL/$filenamewithextensiom\" \"$OUTPUT_FOLDER/ms-ssim/1080_flip_horizontal/$filenamewithoutextension/$filenamewithoutextension\"\"_1080.log\""
    bash -c "do_process \"$main_file\" \"$INPUT_FOLDER_720_FLIP_HORIZONTAL/$filenamewithextensiom\" \"$OUTPUT_FOLDER/ms-ssim/720_flip_horizontal/$filenamewithoutextension/$filenamewithoutextension\"\"_720.log\""
    bash -c "do_process \"$main_file\" \"$INPUT_FOLDER_480_FLIP_HORIZONTAL/$filenamewithextensiom\" \"$OUTPUT_FOLDER/ms-ssim/480_flip_horizontal/$filenamewithoutextension/$filenamewithoutextension\"\"_480.log\""
    bash -c "do_process \"$main_file\" \"$INPUT_FOLDER_360_FLIP_HORIZONTAL/$filenamewithextensiom\" \"$OUTPUT_FOLDER/ms-ssim/360_flip_horizontal/$filenamewithoutextension/$filenamewithoutextension\"\"_360.log\""
    bash -c "do_process \"$main_file\" \"$INPUT_FOLDER_240_FLIP_HORIZONTAL/$filenamewithextensiom\" \"$OUTPUT_FOLDER/ms-ssim/240_flip_horizontal/$filenamewithoutextension/$filenamewithoutextension\"\"_240.log\""
    bash -c "do_process \"$main_file\" \"$INPUT_FOLDER_144_FLIP_HORIZONTAL/$filenamewithextensiom\" \"$OUTPUT_FOLDER/ms-ssim/144_flip_horizontal/$filenamewithoutextension/$filenamewithoutextension\"\"_144.log\""

    bash -c "do_process \"$main_file\" \"$INPUT_FOLDER_1080_ROTATE_90_CLOCKWISE/$filenamewithextensiom\" \"$OUTPUT_FOLDER/ms-ssim/1080_rotate_90_clockwise/$filenamewithoutextension/$filenamewithoutextension\"\"_1080.log\""
    bash -c "do_process \"$main_file\" \"$INPUT_FOLDER_720_ROTATE_90_CLOCKWISE/$filenamewithextensiom\" \"$OUTPUT_FOLDER/ms-ssim/720_rotate_90_clockwise/$filenamewithoutextension/$filenamewithoutextension\"\"_720.log\""
    bash -c "do_process \"$main_file\" \"$INPUT_FOLDER_480_ROTATE_90_CLOCKWISE/$filenamewithextensiom\" \"$OUTPUT_FOLDER/ms-ssim/480_rotate_90_clockwise/$filenamewithoutextension/$filenamewithoutextension\"\"_480.log\""
    bash -c "do_process \"$main_file\" \"$INPUT_FOLDER_360_ROTATE_90_CLOCKWISE/$filenamewithextensiom\" \"$OUTPUT_FOLDER/ms-ssim/360_rotate_90_clockwise/$filenamewithoutextension/$filenamewithoutextension\"\"_360.log\""
    bash -c "do_process \"$main_file\" \"$INPUT_FOLDER_240_ROTATE_90_CLOCKWISE/$filenamewithextensiom\" \"$OUTPUT_FOLDER/ms-ssim/240_rotate_90_clockwise/$filenamewithoutextension/$filenamewithoutextension\"\"_240.log\""
    bash -c "do_process \"$main_file\" \"$INPUT_FOLDER_144_ROTATE_90_CLOCKWISE/$filenamewithextensiom\" \"$OUTPUT_FOLDER/ms-ssim/144_rotate_90_clockwise/$filenamewithoutextension/$filenamewithoutextension\"\"_144.log\""

    bash -c "do_process \"$main_file\" \"$INPUT_FOLDER_1080_ROTATE_90_COUNTERCLOCKWISE/$filenamewithextensiom\" \"$OUTPUT_FOLDER/ms-ssim/1080_rotate_90_counterclockwise/$filenamewithoutextension/$filenamewithoutextension\"\"_1080.log\""
    bash -c "do_process \"$main_file\" \"$INPUT_FOLDER_720_ROTATE_90_COUNTERCLOCKWISE/$filenamewithextensiom\" \"$OUTPUT_FOLDER/ms-ssim/720_rotate_90_counterclockwise/$filenamewithoutextension/$filenamewithoutextension\"\"_720.log\""
    bash -c "do_process \"$main_file\" \"$INPUT_FOLDER_480_ROTATE_90_COUNTERCLOCKWISE/$filenamewithextensiom\" \"$OUTPUT_FOLDER/ms-ssim/480_rotate_90_counterclockwise/$filenamewithoutextension/$filenamewithoutextension\"\"_480.log\""
    bash -c "do_process \"$main_file\" \"$INPUT_FOLDER_360_ROTATE_90_COUNTERCLOCKWISE/$filenamewithextensiom\" \"$OUTPUT_FOLDER/ms-ssim/360_rotate_90_counterclockwise/$filenamewithoutextension/$filenamewithoutextension\"\"_360.log\""
    bash -c "do_process \"$main_file\" \"$INPUT_FOLDER_240_ROTATE_90_COUNTERCLOCKWISE/$filenamewithextensiom\" \"$OUTPUT_FOLDER/ms-ssim/240_rotate_90_counterclockwise/$filenamewithoutextension/$filenamewithoutextension\"\"_240.log\""
    bash -c "do_process \"$main_file\" \"$INPUT_FOLDER_144_ROTATE_90_COUNTERCLOCKWISE/$filenamewithextensiom\" \"$OUTPUT_FOLDER/ms-ssim/144_rotate_90_counterclockwise/$filenamewithoutextension/$filenamewithoutextension\"\"_144.log\""
